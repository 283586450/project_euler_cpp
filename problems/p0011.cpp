...
constexpr std::array<std::array<std::uint32_t, 20>, 20> grid{{
...
std::uint64_t product_right(std::size_t row, std::size_t col) noexcept {
...
std::uint64_t product_down(std::size_t row, std::size_t col) noexcept {
  std::uint64_t product = 1;
  for (std::size_t offset = 0; offset < 4; ++offset) {
...
std::uint64_t product_down_right(std::size_t row, std::size_t col) noexcept {
  std::uint64_t product = 1;
  for (std::size_t offset = 0; offset < 4; ++offset) {
...
std::uint64_t product_down_left(std::size_t row, std::size_t col) noexcept {
  std::uint64_t product = 1;
  for (std::size_t offset = 0; offset < 4; ++offset) {
    product *= grid[row + offset][col - offset];
  }
...
std::uint64_t greatest_product() noexcept {
  std::uint64_t best = 0;
